...
filename=[num_direct4,'max_data'];
num_data4=load(filename);
...
filename=[num_direct4,'max_rate'];
num_rate4=load(filename);
% rate data
...
filename=[num_direct3,'max_data_rate'];
num_datarate3=load(filename);
filename=[num_direct4,'max_data_rate'];
num_datarate4=load(filename);
...
if(series==1)
  if(weighted_option==1)
    ...
    num_data3(:,6)=data(:,1);
    num_data3(:,5)=data(:,2);
    filename=[num_direct4,'max_data_vol'];
    data=load(filename);
    num_data4(:,6)=data(:,1);
    num_data4(:,5)=data(:,2);
  elseif(weighted_option==2)
    ...
    num_data3(:,6)=data(:,1);
    num_data3(:,5)=data(:,2);
    filename=[num_direct4,'max_data_num'];
    data=load(filename);
    num_data4(:,6)=data(:,1);
    num_data4(:,5)=data(:,2); 
  elseif(weighted_option==3)
    ...
    num_data3(:,6)=data(:,1);
    num_data3(:,5)=data(:,2);
    filename=[num_direct4,'max_data_geo'];
    data=load(filename);
    num_data4(:,6)=data(:,1);
    num_data4(:,5)=data(:,2); 
  end
...
p=plot(exp_fv(:,1)*10,exp_fv(:,2),'ok',...
     ...
     num_data4(:,1)*1000,num_data4(:,3)*10^6,':k',...
     'LineWidth',2,...
     'MarkerEdgeColor','k',...    
     'MarkerSize',8);set(p, {'MarkerFaceColor'} , {'k';'none';'none';'none';'none'})  %none means no filling
...
% savename=[direct_save,'analysis_fv'];
% saveas(gcf,savename,'epsc');
savename=[direct_save,'analysis_fv.eps'];
...
p=semilogy(exp_N(:,1),exp_N(:,2)*10^6,'ok',...
     ...
     num_data4(:,1)*1000,num_data4(:,4),':k',...     
     'LineWidth',2,...
     'MarkerEdgeColor','k',...    
     'MarkerSize',8);set(p, {'MarkerFaceColor'} , {'k';'none';'none';'none';'none'})  %none means no filling
leg=legend('Exp.',lab1,lab2,lab3,lab4);set(leg,'FontSize',18,'FontName','Times New Roman','Box','off','Interpreter','latex')
xxx=xlabel('HAB (mm) ');set(xxx,'FontSize',18,'FontName','Times New Roman','Interpreter','latex')
xlim([10,80]);
ylim([10^14,10^20]);
...
set(gcf,'Position',[x0,y0,width,height]);
direct_save='/Users/sunbinxuan/Desktop/laminar_case/fig_in_paper/';
% savename=[direct_save,'analysis_N'];
% saveas(gcf,savename,'epsc');
savename=[direct_save,'analysis_N.eps'];
hgexport(gcf,savename);
...
p=semilogy(exp_np(:,1)*10,exp_np(:,2),'ok',...
     ...
     num_data4(:,1)*1000,num_data4(:,6),':k',... 
     'LineWidth',2,...
     'MarkerEdgeColor','k',...    
     'MarkerSize',8);set(p, {'MarkerFaceColor'} , {'k';'none';'none';'none';'none'})  %none means no filling
%leg=legend('Exp.',lab1,lab2,lab3,lab4);set(leg,'FontSize',18,'FontName','Times New Roman')
...
set(gcf,'Position',[x0,y0,width,height]);
direct_save='/Users/sunbinxuan/Desktop/laminar_case/fig_in_paper/';
% savename=[direct_save,'analysis_avnp'];
% saveas(gcf,savename,'epsc');
savename=[direct_save,'analysis_avnp.eps'];
hgexport(gcf,savename);
...
p=plot(exp_dp(:,1)*10,exp_dp(:,2),'ok',...
     ...
     num_data4(:,1)*1000,num_data4(:,5),':k',... 
     'LineWidth',2,...
     'MarkerEdgeColor','k',...    
     'MarkerSize',8);set(p, {'MarkerFaceColor'} , {'k';'none';'none';'none';'none'})
%leg=legend('Exp.',lab1,lab2,lab3,lab4);set(leg,'FontSize',18,'FontName','Times New Roman')
xxx=xlabel('HAB (mm) ');set(xxx,'FontSize',18,'FontName','Times New Roman','Interpreter','latex')
xlim([0,80]);
ylim([1,80]);
...
set(gcf,'Position',[x0,y0,width,height]);
direct_save='/Users/sunbinxuan/Desktop/laminar_case/fig_in_paper/';
% savename=[direct_save,'analysis_dp'];
% saveas(gcf,savename,'epsc');
savename=[direct_save,'analysis_dp.eps'];
hgexport(gcf,savename);
...
p=semilogy(exp_Nop(:,1)*10,exp_Nop(:,2)*10^6,'ok',...
      ...
      num_data4(:,1)*1000,num_data4(:,7),':k',...   
     'LineWidth',2,...
     'MarkerEdgeColor','k',...    
     'MarkerSize',8);set(p, {'MarkerFaceColor'} , {'k';'none';'none';'none';'none'})
%leg=legend('Exp.',lab1,lab2,lab3,lab4);set(leg,'FontSize',18,'FontName','Times New Roman')
...
set(gcf,'Position',[x0,y0,width,height]);
direct_save='/Users/sunbinxuan/Desktop/laminar_case/fig_in_paper/';
% savename=[direct_save,'analysis_Np'];
% saveas(gcf,savename,'epsc');
savename=[direct_save,'analysis_Np.eps'];
hgexport(gcf,savename);
...
num_rate3(index_remove,:)=[];
num_rate4(index_remove,:)=[];
...
p=plot(num_rate1(:,1)*1000,num_rate1(:,8),'-k',...
      ...
      num_rate3(:,1)*1000,num_rate3(:,8),'-.k',...
      num_rate4(:,1)*1000,num_rate4(:,8),':k',...
     'LineWidth',2,...
     'MarkerEdgeColor','k',...    
     'MarkerSize',8);set(p, {'MarkerFaceColor'} , {'none';'none';'none';'none'})
...
direct_save='/Users/sunbinxuan/Desktop/laminar_case/fig_in_paper/';
% 
% savename=[direct_save,'analysis_area'];
% saveas(gcf,savename,'epsc');
savename=[direct_save,'analysis_area.eps'];
hgexport(gcf,savename);
...
p=plot(num_rate1(:,1)*1000,num_rate1(:,7),'-k',...
      ...
      num_rate4(:,1)*1000,num_rate4(:,7),':k',...    
     'LineWidth',2,...
     'MarkerEdgeColor','k',...    
     'MarkerSize',8);set(p, {'MarkerFaceColor'} , {'none';'none';'none';'none'})
leg=legend(lab1,lab2,lab3,lab4);set(leg,'FontSize',18,'FontName','Times New Roman')
xxx=xlabel('HAB (mm) ');set(xxx,'FontSize',18,'FontName','Times New Roman')
xlim([10,60]);
ylim([800,2000]);
yyy=ylabel('T [K]');set(yyy,'FontSize',18,'FontName','Times New Roman')
set(gca,'FontSize',18,'FontName', 'Times New Roman','color','w')
set(gcf,'Position',[x0,y0,width,height]);